...
const char* stations[] = { "Девяткино", "Гр.Проспект", "Академическая", "Политехническая", "Площадь_мужества", "Лесная", "Выборгская", "Площадь_Ленина", "Чернышевская", "Площадь_Восстания", "Владимирская", "Пушкинская", "Техн.Институт_1", "Балтийская", "Нарвская", "Кировский_завод", "Автово", "Ленинский_роспект", "Проспект_Ветеранов", "Парнас", "Проспект_Просвящения", "Озерки", "Удельная", "Пионерская", "Черная_речка", "Петроградская", "Горьковская", "Невский_проспект", "Сенная_площадь", "Техн.Институт 2", "Фрунзенская", "Московские_ворота", "Электросила", "Парк_Победы", "Московская", "Звездная", "Купчино", "Беговая", "Зенит", "Приморская", "Василеостровская", "Гостиный_двор", "Маяковская", "Пл.Александра_Невского_1", "Елизаровская", "Ломоносовская", "Пролетарская", "Обухово", "Рыбацкое", "Спасская", "Достоевская", "Лиговский_проспект", "Пл.Александра_Невского_2", "Новочеркасская", "Ладожская", "Проспект_Большевиков", "Улица_Дыбенко", "Комендантский_проспект", "Старая_деревня", "Крестовский_остров", "Чкаловская", "Спортивная", "Адмиралтейская", "Садовая", "Звенигородская", "Обводный_канал", "Волковская", "Бухарестская", "Международная", "Проспект_Славы", "Дунайская", "Шушары" };
...
{
	for (int i = 0; i < 72 /*&& station[i] != 10*/; i++)
	{
